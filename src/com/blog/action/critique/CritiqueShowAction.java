...
import com.blog.action.article.ArticleShowAction;
...
public class CritiqueShowAction {
	...
	private static Logger logger = Logger.getLogger(CritiqueShowAction.class);
	...
	public String execute(){
		...
		allCritiques = critiqueServiceImpl.getCritiquesByType("留言", (page-1)*pageSize, pageSize);
